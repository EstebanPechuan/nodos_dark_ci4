<section class="section-nosotros">
    <div class="nosotros-texto">
        <h1>¿Quienes somos?</h1>
        <p>NODOS es una empresa Argentina, cuya actividad principal es brindar a sus clientes soluciones integrales de servicios IT. 
        <br><br>
        Con una amplia trayectoria en el mercado, conteniendo a sus clientes con el conocimiento, profesionalismo y capacidad operativa que constituye nuestro valor diferencial.
        <br><br>
        Nuestro trabajo nos permite desarrollar soluciones innovadoras a medida, construyendo experiencias digitales significativas y de impacto, en tiempo y forma, de acuerdo a las necesidades técnicas y funcionales de cada uno de nuestros clientes.</p>
    </div>

    <div class="nosotros-img">
        <img src=" <?php echo base_url('public/img/mision-vision/home.png') ?> " alt="">
    </div>
</section>
...
<section class="mision">
    <div class="mision-img">
        <img src=" <?php echo base_url('public/img/home-new-img/mision.jpeg') ?> " alt="">
    </div>
...
<section class="vision">
    ...
    <div class="vision-img">
        <img src=" <?php echo base_url('public/img/mision-vision/vision.png') ?> " alt="">
    </div>
</section>
